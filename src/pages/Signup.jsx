...
import registrationImage from '../assets/registration_image.jpg';
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="w-1/2 p-8">
        ...
        <p className="mb-6">
          We need you to help us with some basic information for your account creation. Here are our <a href="#" className="text-blue-500">terms and conditions</a>. Please read them carefully. We are GDPR compliant.
        </p>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms">I agree with <a href="#" className="text-blue-500">terms and conditions</a>.</label>
          </div>
          <button
            type="submit"
            className="w-full py-3 px-4 bg-black text-white font-semibold rounded-lg shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 cursor-pointer"
      ...
      <div className="w-1/2 bg-gray-100 flex items-center justify-center">
        <img src={registrationImage} alt="Registration Image" className="w-full h-auto" />
      </div>
    </div>
  );
};
